...
public class Reporting extends TestListenerAdapter {
		...
		public ExtentHtmlReporter htmlReporter; //Html configuration
		public ExtentReports extent; //attach extent report
		public ExtentTest xTest; //Check testcase status
	  ...
	  public void onStart(ITestContext testContext) {
		  ...
		  extent.setSystemInfo("QA Name", "Pooja");
	  ...
	  public void onTestFailure(ITestResult tr) {
		  ...
		  xTest.getExtent().createTest(tr.getName());
		  ...
		  File file = new File(screenshotpath);
		  	...
		  	{
		  		try {
		  			xTest.fail("Screen shot for the test failed is : " + xTest.addScreencastFromPath(screenshotpath));
		  		} catch (IOException e)
		  		{
		  			e.printStackTrace();
		  		}
